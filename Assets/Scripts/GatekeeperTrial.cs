...
public class GatekeeperTrial : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        rightInfo1.InformationText = "mais je vous rassure, il a �t� bien accueilli";
        ...
        rightInfo2.InformationText = "je peux vous dire qu'il va bien, il est heureux de son s�jour ici.";
        ...
        rightInfo4.InformationText = "Il est parti profiter d'un d�licieux repas, une sp�cialit� d'ici";
