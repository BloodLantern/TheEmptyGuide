...
//using FMODUnity;
//using FMOD.Studio;
////using Com.Isartdigital.Ricotta.Game.Physics;
////using JetBrains.Annotations;
//using Unity.VisualScripting;
//using Com.Isartdigital.Ricotta.Game.UI;

//namespace Com.Isartdigital.Ricotta
//{
...
//		{
//			EventInstance lInstance;
//			lInstance = GetEventInstance(pEventPath);
//			lInstance.start();
//		}
